...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form role="form" class="parsley-examples mt-5" id="ConpanyForm" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    <label for="lab_email" class="col-sm-4 col-form-label">Email<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="email" required class="form-control" id="lab_email"
                            name="lab_email" placeholder="Email">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="lab_image" class="col-sm-4 col-form-label">Lab Logo<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input type="file" required class="form-control border-0" id="lab_image"
                            name="lab_image">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="lab_address" class="col-sm-4 col-form-label">Address<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <textarea required class="form-control" id="lab_address"
                            name="lab_address"></textarea>
                    </div>
                </div>
