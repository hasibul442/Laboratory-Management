...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a onclick="window.history.back()">Ultrasonography</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="text-center">{{ $ultrasonography->test->cat_name }}</h3>
                <div class="row mt-5">
                    <div class="col-md-12">
                        <form class="form-horizontal" action="{{ url('/ultrasonography/result/' . $ultrasonography->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="patient_name"
                                        value="{{ $ultrasonography->patients->name }}" name="patient_name" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="patient_id"
                                        value="{{ $ultrasonography->patients->patient_id }}" name="patient_id" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="invoice_no"
                                        value="{{ $ultrasonography->invoice->bill_no }}" name="invoice_no" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-sm-2 col-form-label">Test Result<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <textarea id="editor" name="testresult" required>{{ $ultrasonography->testresult }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 offset-sm-6">
                                <a href="{{ route('ultrasonography') }}" class="btn btn-primary">Back</a>
