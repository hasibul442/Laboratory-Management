...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Ultrasonography</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Ultrasonography Pending Test</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="card">
            <div class="card-body">
                <h1 class="text-center">Today Pending Ultrasonography Test</h1>
