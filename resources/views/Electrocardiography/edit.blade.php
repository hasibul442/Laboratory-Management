                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a onclick="window.history.back()">Electrocardiography</a></li>
                        ...
                        <form class="form-horizontal"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="patient_name"
                                        value="{{ $Electrocardiography->patients->name }}" name="patient_name" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="patient_id"
                                        value="{{ $Electrocardiography->patients->patient_id }}" name="patient_id" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control border-0 bg-white" id="invoice_no"
                                        value="{{ $Electrocardiography->invoice->bill_no }}" name="invoice_no" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-sm-2 col-form-label">Test Result<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <textarea id="editor" name="testresult" required>{{ $Electrocardiography->testresult }}</textarea>
                                </div>
                            </div>
