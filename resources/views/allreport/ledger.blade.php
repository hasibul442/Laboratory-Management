        ...
        <div class="card-body">
            ...
            <form action="/ledger/details">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" required class="form-control border border-primary" name="from" id="from">
                  </div>
                  <div class="form-group">
                    <label for="datepicker" class="text-dark">To Date</label>
                    <input type="text" required class="form-control border border-primary" name="to" id="to">
                  </div>
