                    ...
                    i ||
                        ...
                        (l &&
                            ...
                            e.isPropagationStopped() &&
                                f.addEventListener(d, bt),
                            n[d](),
                            e.isPropagationStopped() &&
                                f.removeEventListener(d, bt),
            ...
            Ti = (function () {
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(fi)
                            ? (n.closest(yi).find(_i).addClass(hi),
                              n.addClass(hi))
                            : (n.addClass(hi),
                              n
                                  .parents(pi)
            ...
            slimScroll: function (S) {
                ...
                return (
                    this.each(function () {
                        ...
                        if (h.parent().hasClass(A.wrapperClass)) {
                            ...
                            if (
                                ...
                                if ("scrollTo" in S) d = parseInt(A.scrollTo);
                                    ...
                                    return (
                                        b.remove(), y.remove(), void h.unwrap()
                                    );
                                E(d, !1, !0);
                            }
                        ...
                        function T() {
                            (s = Math.max(
                                (h.outerHeight() / h[0].scrollHeight) *
                                    h.outerHeight(),
                                c
                            )),
                                b.css({ height: s + "px" });
                            ...
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                if (
                                    ...
                                    var r = n
                                        ...
                                        .siblings()
                                        .children(
                                            this.config.subMenu + "." + h
                                        );
                                    this.hide(r);
                                }
                                n.removeClass(d).addClass(p).height(0),
                                    this.setTransitioning(!0);
                        ...
                        if (!this.transitioning && a(e).hasClass(h)) {
                            ...
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                n
                                    ...
                                    n.addClass(p).removeClass(d).removeClass(h),
                                    this.setTransitioning(!0);
                                var r = function () {
                                    t.config &&
                                        t.element &&
